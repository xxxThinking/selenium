...
class TestCases(unittest.TestCase):
    ...
    def test_add(self):
        ...
        self.driver.find_element(By.ID, "account").send_keys("shelly21")
        ...
        self.driver.find_element(By.ID, "realname").send_keys("shelly21")
        ...
        self.driver.find_element(By.ID, "value1").send_keys("shelly21")
        self.driver.find_element(By.ID, "submit").click()
